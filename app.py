...
# ==============================================================================
# 1. VISUAL MATRIX LAYOUT DESIGN & PREMIUM BORDER STYLE MATRICES
# ==============================================================================
st.set_page_config(
...
# Loaded static core style configurations once on launch to avoid browser stalling
st.markdown("""
    <style>
    .main { 
...
# ==============================================================================
# 2. MARKET DATA CAPTURE AND MULTI-ASSET AI PIPELINE CONFIGURATIONS
# ==============================================================================
watchlist = {
...
def load_realtime_market_updates():
    ...
    st.session_state.live_prices_cache = store
    return store
