...
# 1. VISUAL LAYER CONFIGURATION & CHROMATIC BORDER ANIMATION MATRICES
...
st.markdown("""
    ...
    /* MOVING CHROMATIC GRADIENT CONTAINER BOXES */
    .metric-box {
        position: relative;
    ...
    .metric-box::before {
        ...
        z-index: -1;
        border-radius: 14px;
        animation: border-glow-wave 4s linear infinite;
    }
    
    /* DYNAMIC DECISION STATE GLOW COLOR PALETTES */
...
# 🚀 HIGH-VELOCITY HEARTBEAT AUTO-REFRESH CONTAINER (ELIMINATES INFINITE WHILE LOOPS)
