...
if submit_button and user_input_text:
    ...
    with st.chat_message("assistant"):
        ...
        # 🧠 LINEAR CHAT HANDSHAKE - BRINGING YOUR 120B BRAIN BACK ONTO COMPACT NO-INDEPENDENCE ROWS
...
# 🔥 UN-TRUNCATED BACKGROUND REFRESH CLOCK PASS (LOCAL RE-DEFINITION RESTORED)
while True:
    local_tz = pytz.timezone("America/Toronto")
